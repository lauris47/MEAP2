\section{Evaluation}
This section will attempt to evaluate the control schemes and will cover methods and different approaches planned to be used when conducting evaluation. 
It will be discussed why usability testing and performance testing methods were chosen for evaluation of the prototype and why it seemed most efficient and suitable. After that it will be elaborated on why card sorting method was used for gaining feedback from the users. 
After these sections the procedure of how the test is planned and analyzed after will be described. 
