...
An important thing to remember for the validity of the test is as Jakob Nielsen states, \textit{listening to what people say is misleading: you have to watch what they actually do.}\cite{Usability}
...
The final problem statement is interested in making an application that minimizes the knowledge gap using familiarity. \pageref{FPS}
