...
\todo{source for the example}An example of which could be the iBooks app for 
iPad.
\begin{figure}[H]
\centering
...
design, 2015)\todo{citation needed}. Covered usability goals are:
>>>>>>> origin/master
\begin{itemize}
...
=======
Wiley notes that not all of the goals are needed for most of the systems. 
...
(Norman, The Design of Everyday Things, 1988)\todo{citation needed}  Principle is 
...
\cite {Norman}
=======
\todo{citation}(Norman, The Design of Everyday Things, 1988)
>>>>>>> origin/master
...
\todo{citation}. Even small aspects like person’s bigger fingers can cause 
