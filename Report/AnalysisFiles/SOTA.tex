...
here the analysis will try to determine if the app successfully bridges the knowledge gap talked about in ux section ref: fig. \ref{fig:Knowledge}.
\item The graphical design: Colours and layout.
